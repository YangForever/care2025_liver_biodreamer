...
def moving_validation_data(base_dir, target_dir):
    """
...
def moving_validation_data_all_modality(base_dir, target_dir):
    """
    Move the LIQA annotated data from the base directory to the target directory.
    """
    base_dir = Path(base_dir)
...
def moving_train_GED4_data(base_dir, target_dir):
    """
    Move the LIQA annotated data from the base directory to the target directory.
    """
    base_dir = Path(base_dir)
...
def moving_train_data_all_modality(base_dir, target_dir):
    """
    Move the LIQA annotated data from the base directory to the target directory.
    """
