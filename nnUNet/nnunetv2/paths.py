...
# Fallback to hardcoded paths if environment variables are not set
nnUNet_raw = os.environ.get('nnUNet_raw', '/app/nnUNet_raw')
nnUNet_preprocessed = os.environ.get('nnUNet_preprocessed', '/app/nnUNet_preprocessed')
nnUNet_results = os.environ.get('nnUNet_results', '/app/nnUNet_results')

# Original hardcoded configuration (kept for reference but not used)
...
if nnUNet_results is None:
    print("nnUNet_results is not defined and nnU-Net can not be used for inference "
          "with pretrained models. If this is not intended, please read documentation/setting_up_paths.md for "
          "information on how to set this up.")

print(f"nnUNet paths:")
